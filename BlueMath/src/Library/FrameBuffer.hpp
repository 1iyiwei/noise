...
public:
    ...
    static int WriteFIG(const vector<L2F> & samples, const vector<Tile> & tiles, const vector<P3> & palette, const vector<float> & region, const float sample_radius, const int tile_boundary, const int region_boundary, const int color_scheme, const string & file_name);
