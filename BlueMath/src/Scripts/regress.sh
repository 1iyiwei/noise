...
./src/Main/Release/DartThrowing ${measure} ${dimension} ${r_value} ${k_value} ${domain_size} ${boundary} ${sample_grid_resolution_per_unit_domain} ${output_dir}/${domain_option}.f2m ${max_importance_arg} ${importance_cell_size} > ${huge_dir}/${base_name}_${i}.txt
...
./src/Main/Release/NormF2M "div" 1 ${output_dir}/${head_name}_poisson_${tail_name}_average${num_runs}.f2m ${output_dir}/${head_name}_white_${tail_name}_average${num_runs}.f2m ${output_dir}/${head_name}_${method}_${tail_name}_average${num_runs}.f2m;
...
./src/Main/Release/DrawSamples ${huge_dir}/${draw_name}_${i}.txt ${huge_dir}/${draw_name}_${i}.fig ${dimension} ${dot_radius} 1 ${domain_size} ${huge_dir}/palette.txt
...
./src/Main/Release/SampleSelector ${huge_dir}/${inverse_name}_${i}.txt ${dimension} "cout" 0 > ${huge_dir}/${inverse_name}_${i}_selected.txt
...
set final_samples = `./src/Main/Release/SampleSelector ${huge_dir}/${inverse_name}_${i}.txt ${dimension} cout 0`;
