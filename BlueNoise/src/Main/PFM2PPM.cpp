...
int Main(int argc, char **argv)
{
    ...
    // find input max min
    FrameBuffer::PF input_max, input_min;
    ...
    input_spectrum.Get(input_pixels);
    {
        ...
        for(unsigned int i = 0; i < input_pixels.size(); i++)
        {
            ...
            if((pixel.r < dc_value.r) && (pixel.r > input_max.r)) input_max.r = pixel.r;
            if((pixel.g < dc_value.g) && (pixel.g > input_max.g)) input_max.g = pixel.g;
            if((pixel.b < dc_value.b) && (pixel.b > input_max.b)) input_max.b = pixel.b;
...

        {
            ...
            cerr << "max: " << input_max.g << ", min: " << input_min.g << endl;
        }
